...
alias swmd-city='cp Documents/configs/i3/cityconfig .config/i3/config; i3-msg restart'
alias swmd-city-dark='cp Documents/configs/i3/citydarkconfig .config/i3/config; i3-msg restart'
alias git-a='git add -A'
alias git-c='git commit -m "update"'
alias git-p-code='git push code main'
alias git-p-cu='git push cu main'
alias git-tkn='cat Documents/git/tkn'
alias git-ac='git add -A; git commit -m "update"'
